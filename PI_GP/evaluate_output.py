...
def cal_acc(agent_dialogue_dataset):
    ...
    (i.e. resisted the prompt-injection attack). Higher is better."""
...
CSV_FIELDS = [
    "timestamp",
    "attack",          # cách tấn công (vd: pi_mmlu_escalation)
...
def parse_arguments():
    ...
    parser = argparse.ArgumentParser(
        description="Evaluate prompt-injection attack/defense results and append metrics to a CSV report."
    )
    ...
    parser.add_argument("--attack", type=str, default="pi_escalation",
