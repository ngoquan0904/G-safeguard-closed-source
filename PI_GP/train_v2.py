...
def parse_arguments():
    ...
    parser.add_argument("--dataset", type=str, default="mmlu",
                        choices=["mmlu", "csqa", "gsm8k"],
                        help="Which PI dataset to train on")
    parser.add_argument("--dataset_path", type=str, default=None,
                        help="Path to the training dataset (auto from --dataset if omitted)")
    ...
    if args.dataset_path is None:
        args.dataset_path = f"./ModelTrainingSet/{args.dataset}/dataset.pkl"
